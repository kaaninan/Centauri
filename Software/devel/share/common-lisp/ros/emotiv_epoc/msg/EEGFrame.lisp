...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EEGFrame>)))
  ...
  "92a93661fa971fb7494f0877c88d2361")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EEGFrame)))
  "Returns md5sum for a message object of type 'EEGFrame"
  "92a93661fa971fb7494f0877c88d2361")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EEGFrame>)))
  ...
  (cl:format cl:nil "Header header~%int32 accel_x~%int32 accel_y~%~%uint32 channel_count~%string[] channel_names~%int32[] signals~%int32[] qualities~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EEGFrame)))
  "Returns full string definition for message of type 'EEGFrame"
  (cl:format cl:nil "Header header~%int32 accel_x~%int32 accel_y~%~%uint32 channel_count~%string[] channel_names~%int32[] signals~%int32[] qualities~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
